...
function checkUnits(minTempC, maxTempC, minTempF, maxTempF) {
  var checkboxInput = document.getElementById("unitMode_checkbox");
...
function createCurrentDataUI(data) {
  ...
  var currentTempC = document.querySelector(".currentTempC");
  var currentTempF = document.querySelector(".currentTempF");
  var conditionIcon = document.querySelector(".conditionIcon");
  var condition = document.querySelector(".condition");
  if (data.locationData.country === "United States of America") {
    location.textContent = "".concat(data.locationData.name, ", ").concat(data.locationData.region);
  } else {
    location.textContent = "".concat(data.locationData.name, ", ").concat(data.locationData.country);
  }
  lastUpdated.textContent = "Last Updated: ".concat(data.currentData.last_updated_date_formatted);
  ...
  //  Right side data
  var feelsLikeC = document.querySelector(".feelsLikeC");
  var feelsLikeF = document.querySelector(".feelsLikeF");
  var humidity = document.querySelector(".humidity");
  var rainChance = document.querySelector(".rainChance");
  var windSpeedKph = document.querySelector(".windSpeedKph");
...
function addFadeInAnimation() {
  var animatedDivs = document.querySelectorAll(".fade-in");
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n  --white: #f5f5f5;\n}\n\n@font-face {\n  font-family: \"Montserrat\";\n  src: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ") format(\"truetype\");\n  font-weight: 100 900;\n}\n\n* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n  font-family: \"Montserrat\", system-ui, \"Segoe UI\", sans-serif;\n  font-weight: 400;\n}\n\nbody {\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ");\n  background-size: cover;\n  background-position: center;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  min-height: 100vh;\n}\n\n/* Current weather data section */\n.currentDataDiv,\n.forecastDiv {\n  color: var(--white);\n  background-color: rgb(0, 0, 0, 0.2);\n}\n\n.currentDataDiv {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 5rem;\n}\n\n/* Fade in animation */\n.fade-in {\n  animation: fadeIn 1s;\n}\n\n@keyframes fadeIn {\n  0% {\n    opacity: 0.1;\n    transform: scale(0.9, 0.9);\n  }\n  100% {\n    opacity: 1;\n  }\n}\n\n/* Left side of Current weather section */\n.left {\n  display: flex;\n  flex-direction: column;\n  gap: 1rem;\n}\n\n.location {\n  font-size: 2rem;\n  font-weight: 500;\n}\n\n.lastUpdated {\n  font-size: 0.9rem;\n}\n\n.currentTempC,\n.currentTempF {\n  font-size: 3rem;\n  font-weight: 600;\n}\n\n.conditionIconAndText {\n  display: flex;\n  align-items: center;\n  gap: 1rem;\n}\n\n.condition {\n  font-size: 1.5rem;\n}\n\n/* Right side of Current weather section */\n.right {\n  display: flex;\n  flex-direction: column;\n  gap: 1.5rem;\n}\n\n.right_data_div {\n  display: flex;\n  align-items: center;\n  gap: 1.5rem;\n}\n\n.right_data_div i {\n  width: 30px;\n  color: rgb(27, 124, 165, 0.8);\n}\n\n.caption_data {\n  display: flex;\n  flex-direction: column;\n  gap: 0.3rem;\n  width: 120px;\n}\n\n.caption_data div {\n  font-size: 1.5rem;\n  font-weight: 700;\n}\n\n.caption_data .caption {\n  font-size: 0.8rem;\n  font-weight: 400;\n}\n\n/* Forecast section */\n.forecastDiv {\n  display: grid;\n  grid-template-columns: repeat(3, minmax(200px, 1fr));\n  justify-items: center;\n  overflow-x: auto;\n  padding: 2.5rem 5rem;\n}\n\n.forecast_day_div {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  width: 100%;\n  gap: 1.5rem;\n  padding: 2.5rem 0;\n  transition: background-color 0.3s ease-in-out;\n}\n\n.weekday {\n  font-size: 1.3rem;\n  font-weight: 600;\n}\n\n.forecast_maxTemp {\n  font-size: 2rem;\n  font-weight: 700;\n}\n\n.forecast_day_div:hover {\n  background-color: rgb(37, 182, 244, 0.25);\n}\n\n/* Search Query Section */\n.location-search {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 3rem;\n  padding: 1rem;\n}\n\n.searchQueryForm {\n  position: relative;\n  transition: all 0.3s ease-in-out;\n}\n\n.searchQueryForm:hover {\n  transform: scale(1.2);\n}\n\n.searchQueryForm:hover .searchBox {\n  box-shadow: 2px 4px 20px #2e67f8;\n}\n\n.open_form_div:hover {\n  transform: scale(1);\n}\n\n.open_form_div:hover .searchBox {\n  box-shadow: none;\n}\n\n.searchBox {\n  width: 60px;\n  height: 60px;\n  background: none;\n  border-radius: 50px;\n  border: 3px solid var(--white);\n  outline: none;\n  transition: width 0.4s ease-in-out, border-radius 0.8s ease-in-out,\n    padding 0.2s;\n  transition-delay: 0.4s;\n  color: var(--white);\n  font-size: 1.2rem;\n}\n\n.inclicked {\n  width: 360px;\n  border-radius: 30px;\n  padding: 0 1rem;\n}\n\n.searchBtn {\n  position: absolute;\n  width: 60px;\n  height: 60px;\n  top: 0;\n  right: 0;\n  background: none;\n  border: none;\n  outline: none;\n  cursor: pointer;\n}\n\n.searchBtn::before {\n  content: \"\";\n  width: 4px;\n  height: 25px;\n  background: var(--white);\n  position: absolute;\n  transform: rotate(-45deg);\n  bottom: -16px;\n  right: -6px;\n  transition: 0.3s;\n}\n\n.close::after,\n.close::before {\n  content: \"\";\n  width: 4px;\n  height: 34px;\n  background: var(--white);\n  position: absolute;\n  bottom: 12px;\n  right: 28px;\n}\n\n.close::before {\n  transform: rotate(-45deg);\n}\n\n.close::after {\n  transform: rotate(45deg);\n}\n\n.close {\n  transition: all 0.3s ease-in-out;\n}\n\n.close:hover {\n  transform: scale(1.2);\n}\n\n.errorMsg {\n  color: var(--white);\n  font-weight: 500;\n}\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,gBAAgB;AAClB;;AAEA;EACE,yBAAyB;EACzB,+DAA+D;EAC/D,oBAAoB;AACtB;;AAEA;EACE,SAAS;EACT,UAAU;EACV,sBAAsB;EACtB,4DAA4D;EAC5D,gBAAgB;AAClB;;AAEA;EACE,yDAA4D;EAC5D,sBAAsB;EACtB,2BAA2B;EAC3B,aAAa;EACb,sBAAsB;EACtB,8BAA8B;EAC9B,iBAAiB;AACnB;;AAEA,iCAAiC;AACjC;;EAEE,mBAAmB;EACnB,mCAAmC;AACrC;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,8BAA8B;EAC9B,aAAa;AACf;;AAEA,sBAAsB;AACtB;EACE,oBAAoB;AACtB;;AAEA;EACE;IACE,YAAY;IACZ,0BAA0B;EAC5B;EACA;IACE,UAAU;EACZ;AACF;;AAEA,yCAAyC;AACzC;EACE,aAAa;EACb,sBAAsB;EACtB,SAAS;AACX;;AAEA;EACE,eAAe;EACf,gBAAgB;AAClB;;AAEA;EACE,iBAAiB;AACnB;;AAEA;;EAEE,eAAe;EACf,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,SAAS;AACX;;AAEA;EACE,iBAAiB;AACnB;;AAEA,0CAA0C;AAC1C;EACE,aAAa;EACb,sBAAsB;EACtB,WAAW;AACb;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,WAAW;AACb;;AAEA;EACE,WAAW;EACX,6BAA6B;AAC/B;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,WAAW;EACX,YAAY;AACd;;AAEA;EACE,iBAAiB;EACjB,gBAAgB;AAClB;;AAEA;EACE,iBAAiB;EACjB,gBAAgB;AAClB;;AAEA,qBAAqB;AACrB;EACE,aAAa;EACb,oDAAoD;EACpD,qBAAqB;EACrB,gBAAgB;EAChB,oBAAoB;AACtB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,WAAW;EACX,WAAW;EACX,iBAAiB;EACjB,6CAA6C;AAC/C;;AAEA;EACE,iBAAiB;EACjB,gBAAgB;AAClB;;AAEA;EACE,eAAe;EACf,gBAAgB;AAClB;;AAEA;EACE,yCAAyC;AAC3C;;AAEA,yBAAyB;AACzB;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,SAAS;EACT,aAAa;AACf;;AAEA;EACE,kBAAkB;EAClB,gCAAgC;AAClC;;AAEA;EACE,qBAAqB;AACvB;;AAEA;EACE,gCAAgC;AAClC;;AAEA;EACE,mBAAmB;AACrB;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,gBAAgB;EAChB,mBAAmB;EACnB,8BAA8B;EAC9B,aAAa;EACb;gBACc;EACd,sBAAsB;EACtB,mBAAmB;EACnB,iBAAiB;AACnB;;AAEA;EACE,YAAY;EACZ,mBAAmB;EACnB,eAAe;AACjB;;AAEA;EACE,kBAAkB;EAClB,WAAW;EACX,YAAY;EACZ,MAAM;EACN,QAAQ;EACR,gBAAgB;EAChB,YAAY;EACZ,aAAa;EACb,eAAe;AACjB;;AAEA;EACE,WAAW;EACX,UAAU;EACV,YAAY;EACZ,wBAAwB;EACxB,kBAAkB;EAClB,yBAAyB;EACzB,aAAa;EACb,WAAW;EACX,gBAAgB;AAClB;;AAEA;;EAEE,WAAW;EACX,UAAU;EACV,YAAY;EACZ,wBAAwB;EACxB,kBAAkB;EAClB,YAAY;EACZ,WAAW;AACb;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,wBAAwB;AAC1B;;AAEA;EACE,gCAAgC;AAClC;;AAEA;EACE,qBAAqB;AACvB;;AAEA;EACE,mBAAmB;EACnB,gBAAgB;AAClB","sourcesContent":[":root {\n  --white: #f5f5f5;\n}\n\n@font-face {\n  font-family: \"Montserrat\";\n  src: url(./Montserrat-VariableFont_wght.ttf) format(\"truetype\");\n  font-weight: 100 900;\n}\n\n* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n  font-family: \"Montserrat\", system-ui, \"Segoe UI\", sans-serif;\n  font-weight: 400;\n}\n\nbody {\n  background-image: url(\"./Images/weatherapp_background.jpeg\");\n  background-size: cover;\n  background-position: center;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  min-height: 100vh;\n}\n\n/* Current weather data section */\n.currentDataDiv,\n.forecastDiv {\n  color: var(--white);\n  background-color: rgb(0, 0, 0, 0.2);\n}\n\n.currentDataDiv {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 5rem;\n}\n\n/* Fade in animation */\n.fade-in {\n  animation: fadeIn 1s;\n}\n\n@keyframes fadeIn {\n  0% {\n    opacity: 0.1;\n    transform: scale(0.9, 0.9);\n  }\n  100% {\n    opacity: 1;\n  }\n}\n\n/* Left side of Current weather section */\n.left {\n  display: flex;\n  flex-direction: column;\n  gap: 1rem;\n}\n\n.location {\n  font-size: 2rem;\n  font-weight: 500;\n}\n\n.lastUpdated {\n  font-size: 0.9rem;\n}\n\n.currentTempC,\n.currentTempF {\n  font-size: 3rem;\n  font-weight: 600;\n}\n\n.conditionIconAndText {\n  display: flex;\n  align-items: center;\n  gap: 1rem;\n}\n\n.condition {\n  font-size: 1.5rem;\n}\n\n/* Right side of Current weather section */\n.right {\n  display: flex;\n  flex-direction: column;\n  gap: 1.5rem;\n}\n\n.right_data_div {\n  display: flex;\n  align-items: center;\n  gap: 1.5rem;\n}\n\n.right_data_div i {\n  width: 30px;\n  color: rgb(27, 124, 165, 0.8);\n}\n\n.caption_data {\n  display: flex;\n  flex-direction: column;\n  gap: 0.3rem;\n  width: 120px;\n}\n\n.caption_data div {\n  font-size: 1.5rem;\n  font-weight: 700;\n}\n\n.caption_data .caption {\n  font-size: 0.8rem;\n  font-weight: 400;\n}\n\n/* Forecast section */\n.forecastDiv {\n  display: grid;\n  grid-template-columns: repeat(3, minmax(200px, 1fr));\n  justify-items: center;\n  overflow-x: auto;\n  padding: 2.5rem 5rem;\n}\n\n.forecast_day_div {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  width: 100%;\n  gap: 1.5rem;\n  padding: 2.5rem 0;\n  transition: background-color 0.3s ease-in-out;\n}\n\n.weekday {\n  font-size: 1.3rem;\n  font-weight: 600;\n}\n\n.forecast_maxTemp {\n  font-size: 2rem;\n  font-weight: 700;\n}\n\n.forecast_day_div:hover {\n  background-color: rgb(37, 182, 244, 0.25);\n}\n\n/* Search Query Section */\n.location-search {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 3rem;\n  padding: 1rem;\n}\n\n.searchQueryForm {\n  position: relative;\n  transition: all 0.3s ease-in-out;\n}\n\n.searchQueryForm:hover {\n  transform: scale(1.2);\n}\n\n.searchQueryForm:hover .searchBox {\n  box-shadow: 2px 4px 20px #2e67f8;\n}\n\n.open_form_div:hover {\n  transform: scale(1);\n}\n\n.open_form_div:hover .searchBox {\n  box-shadow: none;\n}\n\n.searchBox {\n  width: 60px;\n  height: 60px;\n  background: none;\n  border-radius: 50px;\n  border: 3px solid var(--white);\n  outline: none;\n  transition: width 0.4s ease-in-out, border-radius 0.8s ease-in-out,\n    padding 0.2s;\n  transition-delay: 0.4s;\n  color: var(--white);\n  font-size: 1.2rem;\n}\n\n.inclicked {\n  width: 360px;\n  border-radius: 30px;\n  padding: 0 1rem;\n}\n\n.searchBtn {\n  position: absolute;\n  width: 60px;\n  height: 60px;\n  top: 0;\n  right: 0;\n  background: none;\n  border: none;\n  outline: none;\n  cursor: pointer;\n}\n\n.searchBtn::before {\n  content: \"\";\n  width: 4px;\n  height: 25px;\n  background: var(--white);\n  position: absolute;\n  transform: rotate(-45deg);\n  bottom: -16px;\n  right: -6px;\n  transition: 0.3s;\n}\n\n.close::after,\n.close::before {\n  content: \"\";\n  width: 4px;\n  height: 34px;\n  background: var(--white);\n  position: absolute;\n  bottom: 12px;\n  right: 28px;\n}\n\n.close::before {\n  transform: rotate(-45deg);\n}\n\n.close::after {\n  transform: rotate(45deg);\n}\n\n.close {\n  transition: all 0.3s ease-in-out;\n}\n\n.close:hover {\n  transform: scale(1.2);\n}\n\n.errorMsg {\n  color: var(--white);\n  font-weight: 500;\n}\n"],"sourceRoot":""}]);
// Exports
...
var searchQueryFormDiv = document.querySelector(".searchQueryForm");
var searchQueryForm = document.querySelector("form");
      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 10:
          ...
          if (weather) {
            ...
            errorMsg.textContent = "".concat(searchInputValue, " is not a valid location.");
          }
          searchQueryForm.reset();
        case 13:
        case "end":
